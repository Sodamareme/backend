...
export class LearnersController {
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Validation du fichier terminée', type: ValidationResponseDto })
  @ApiConsumes('multipart/form-data')
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Import en masse terminé', type: BulkImportResponseDto })
  @ApiConsumes('multipart/form-data')
  async bulkImport(
    @UploadedFile() file: Express.Multer.File,
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Création en masse terminée', type: BulkImportResponseDto })
  async bulkCreate(@Body() bulkCreateDto: BulkCreateLearnersDto): Promise<BulkImportResponseDto> {
  ...
  @Roles(UserRole.ADMIN)
  @ApiOperation({ summary: 'Remplacer un apprenant' })
  ...
  async getWaitingList(@Query('promotionId') promotionId?: string): Promise<Learner[]> {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // ROUTES DYNAMIQUES :id (doivent être APRÈS les routes statiques)
  // ─────────────────────────────────────────────────────────────────────────
  ...
  async updateStatus(@Param('id') id: string, @Body('status') status: LearnerStatus) {
